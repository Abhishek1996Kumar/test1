...
public class Gold extends JFrame implements ActionListener{
    
    JLabel heading,gold,l1,l2,l3,l4,l5,l6,l7,l8,price;
    JButton back;
   String Username;
    Gold(String Username)
   ...
   //heading
   heading=new JLabel("Check Out the GOLD PACKAGE and BOOK YOUR DREAM!");
   ...
   //platinum
   gold=new JLabel("GOLD PACKAGE");
   gold.setBounds(50,120,300,30);
   gold.setFont(new Font("Cooper Black",Font.BOLD,25));
   gold.setForeground(new Color(255,140,0));
   add(gold);
   
  
   //features
   l1=new JLabel("5 Days AND 6 Nights");
   ...
   l4=new JLabel("One Day Outer Camping");
   ...
   add(back);
    ...
    //image
     ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("resort.jpg"));
