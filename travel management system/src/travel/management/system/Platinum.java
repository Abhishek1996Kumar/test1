...
public class Platinum extends JFrame implements ActionListener{
    
    JLabel heading,platinum,l1,l2,l3,l4,l5,l6,l7,l8,price;
    JButton back;
   ...
   //heading
   heading=new JLabel("Check Out the PLATINUM PACKAGE and BOOK YOUR DREAM!");
   ...
   //platinum
   platinum=new JLabel("PLATINUM PACKAGE");
   platinum.setBounds(20,120,300,30);
   platinum.setFont(new Font("Cooper Black",Font.BOLD,25));
   platinum.setForeground(new Color(119,136,153));
   add(platinum);
   
  
   //features
   l1=new JLabel("6 Days AND 7 Nights");
   ...
   add(back);
    ...
    //image
     ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("vene.jpg"));
